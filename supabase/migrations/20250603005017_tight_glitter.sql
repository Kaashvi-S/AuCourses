/*
  ...
  1. New Courses
    - Sciences (SCI) courses - 100, 200, and 300 level
    - Social Sciences (SSC) courses - 100, 200, and 300 level
    - Humanities (HUM) courses - 100, 200, and 300 level
  
  2. Cross-listings
    - Added appropriate cross-listings between categories
    - Maintained consistent naming patterns
  
  3. Organization
    - Courses organized by category and level
    - Consistent semester assignments
*/
